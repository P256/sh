...
# 提供二进制文件
echo "export PATH=$mysqlPath/bin:$PATH" > /etc/profile.d/mariadb.sh
# 提供库文件
echo "$mysqlPath/lib" > /etc/ld.so.conf.d/mariadb.conf
# 提供头文件  
ln -sv /usr/local/include /usr/include/mariadb
# 提供man手册  
